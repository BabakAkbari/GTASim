...
// console.log(ffmpeg);
// const process = spawn(ffmpeg, ["-f", "gdigrab", "-framerate", "30", "-i", "desktop", "output.mkv"], { shell: true });
// spawn('cmd', ["/c", ffmpeg, "-t", "4", "-f", "gdigrab", "-framerate", "90", "-i", "title=FiveM - FXServer, but unconfigured", "a.mp4"], { stdio: 'inherit'})
